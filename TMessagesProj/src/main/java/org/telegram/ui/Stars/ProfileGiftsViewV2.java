...
import org.telegram.ui.ProfileActivityV2;

import java.util.ArrayList;
import java.util.HashSet;

public class ProfileGiftsViewV2 extends View implements NotificationCenter.NotificationCenterDelegate {

    private final int currentAccount;
    private final long dialogId;
    private final View avatarContainer;
    private final ProfileActivityV2.AvatarImageView avatarImage;
    private final Theme.ResourcesProvider resourcesProvider;

    public ProfileGiftsViewV2(Context context, int currentAccount, long dialogId, @NonNull View avatarContainer, ProfileActivityV2.AvatarImageView avatarImage, Theme.ResourcesProvider resourcesProvider) {
        super(context);
...
//        }
    ...
    public final class Gift {
        ...
        public final ButtonBounce bounce = new ButtonBounce(ProfileGiftsViewV2.this);
    ...
    protected void dispatchDraw(@NonNull Canvas canvas) {
        ...
        Log.e("STAS", "getWidth()" + getWidth());
        Log.e("STAS", "expandY" + expandY);
