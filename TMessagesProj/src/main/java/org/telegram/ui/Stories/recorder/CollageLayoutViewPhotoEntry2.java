...
import org.telegram.messenger.MediaController;import org.telegram.messenger.R;
...
public class CollageLayoutViewPhotoEntry2 extends FrameLayout implements ItemOptions.ScrimView {
    ...
    public CollageLayoutViewPhotoEntry2(Context context, BlurringShader.BlurManager blurManager, FrameLayout containerView, Theme.ResourcesProvider resourcesProvider) {
        super(context);
...
//                rect.offset(0, -rect.height());
    ...
    public void set(MediaController.PhotoEntry entry, boolean animated) {
    ...
    public boolean push(MediaController.PhotoEntry content) {
    ...
    public ArrayList<MediaController.PhotoEntry> getContent() {
        final ArrayList<MediaController.PhotoEntry> array = new ArrayList<>();
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        if (!hasLayout() || preview || !interceptTouchEvents) {
    ...
    public class Part {
        ...
        private int index;
        private final AnimatedFloat highlightAnimated = new AnimatedFloat(CollageLayoutViewPhotoEntry2.this, 0, 1200, CubicBezierInterpolator.EASE_OUT);

        public final ImageReceiver imageReceiver = new ImageReceiver(CollageLayoutViewPhotoEntry2.this);
        ...
        private MediaController.PhotoEntry content;
        ...
        public void setContent(MediaController.PhotoEntry entry) {
            destroyContent();
            ...
            if (content == null) {
                ...
                videoPlayer = new VideoPlayerHolderBase() {
                    ...
                    protected void onVideoSizeChanged(int width, int height, int unappliedRotationDegrees, float pixelWidthHeightRatio) {
                        AndroidUtilities.runOnUIThread(() -> {
                            MediaController.PhotoEntry e = content;
                            if (e == null) return;
                ...
                imageReceiver.setImage(content.getPath(), filter, null, null, 0);
            }
            invalidate();
        }
