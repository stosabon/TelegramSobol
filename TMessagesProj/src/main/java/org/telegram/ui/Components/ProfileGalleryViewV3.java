...
public class ProfileGalleryViewV3 extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileGalleryViewV3(Context context, ActionBar parentActionBar, RecyclerListView parentListView, Callback callback) {
        super(context);
    ...
    private class AvatarImageView extends BackupImageView {
        ...
        public void invalidate() {
            super.invalidate();
            if (invalidateWithParent) {
                ProfileGalleryViewV3.this.invalidate();
            }
        }
    }
