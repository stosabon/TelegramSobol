...
public class ProfileGalleryViewV2 extends CircularViewPager implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ProfileGalleryViewV2(Context context, long dialogId, ActionBar parentActionBar, RecyclerListView parentListView, ProfileActivityV2.AvatarImageView parentAvatarImageView, int parentClassGuid, Callback callback) {
        super(context);
    ...
    public class ViewPagerAdapter extends Adapter {
        ...
        public ViewPagerAdapter(Context context, ProfileActivityV2.AvatarImageView parentAvatarImageView, ActionBar parentActionBar) {
